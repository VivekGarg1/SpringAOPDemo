...
public class AfterReturningAndThrowingAdviceUsingAnnotationClientTest {
	
	public static void main(String[] args) throws Exception {
		ApplicationContext context=new ClassPathXmlApplicationContext("AfterReturningAndThrowingAdviceUsingAnnotationBeans.xml");
